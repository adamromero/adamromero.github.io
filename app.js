const projects = [
   {
      ...
      description: `The client's goal for this project was to convert their desktop only ecommerce 
         website into a new responsively designed front end, allowing users to access the 
         site with either desktop, tablet, or mobile devices. My involvement included the 
         initial development of the redesign as well as implementing newly proposed features 
         after completion of the redesign. The redesign was successful in that it increased 
         mobile conversion by 500% as well as an over 120% increase on tablet devices. The 
         project was completed in approximately 3 months. Read about the redesign here.`,
      link: "https://web.archive.org/web/20200520070752/https://www.leftlanesports.com/",
   },
];
